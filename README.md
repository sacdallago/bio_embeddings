...
- Release `0.1.4` will be installable on Google Colab. In the meantime, [check out this Google Colab](https://colab.research.google.com/drive/1h5izTF07GjHMkekmGNUj32Sbb1gccJxd?usp=sharing) to get started on-demand GPU computing today! (thanks to Prof. Georgina Stegmayer for helpful input). [This Colab](https://colab.research.google.com/drive/1msZVwcCT2b768HnbRK3SrnmRqtVjvsgg?usp=sharing) allows you to extract features (secondary structure and protein localization) from a FASTA formatted sequence file (directly on Google hardware; **FAST** even if you don't have a GPU on your computer!!).
