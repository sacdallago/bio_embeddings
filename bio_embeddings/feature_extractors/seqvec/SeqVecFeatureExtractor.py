import torch
from bio_embeddings.feature_extractors.FeatureExtractorInterface import FeatureExtractorInterface
from bio_embeddings.feature_extractors.seqvec.feature_inference_models import SUBCELL_FNN, SECSTRUCT_CNN
